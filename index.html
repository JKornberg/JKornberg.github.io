                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-6 col-lg-4 mb-5">
                        <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal2">
                            ...
                            <img class="img-fluid" src="assets/img/portfolio/LucereLabs.jpg" alt="" />
                        </div>
                    </div>
                    <!-- Portfolio Item 3-->
                    <div class="col-md-6 col-lg-4 mb-5">
                        <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal3">
                            ...
                            <img class="img-fluid" src="assets/img/portfolio/RealOrNot.jpg" alt="" />
                        </div>
                    </div>
                    <!-- Portfolio Item 4-->
                    <div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
                        <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal4">
                            ...
                            <img class="img-fluid" src="assets/img/portfolio/3rdparty.jpg" alt="" />
                        </div>
                    </div>
                    <!-- Portfolio Item 5-->
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <button class="btn btn-primary">
                                        <a href="https://drive.google.com/file/d/1GOIkKpldZtqFuAGOWzP25WFcyxYGFhk3/view?usp=sharing">
                                        View Presentation
                                        </a>
                                    </button>
                                    <button class="btn btn-primary" data-dismiss="modal">
